...
public class steps extends BaseClass {
	...
	@io.cucumber.java.en.Given("User Launch Chrome browser")
	...
	@io.cucumber.java.en.When("User opens URL {string}")
	...
	// Adding Customer
	 ...
	 public void user_can_view_Dashboad() {
	  ...
	  Assert.assertEquals("Dashboard / nopCommerce administration",addCust.
	  getPageTitle());
	   }
	...
	public void user_click_on_customers_Menu() throws InterruptedException {
		...
		System.out.println("addcust working?" + addCust);
	...
	public void user_enter_customer_info() throws InterruptedException {
		...
		addCust.setFirstName("TestKavya");
